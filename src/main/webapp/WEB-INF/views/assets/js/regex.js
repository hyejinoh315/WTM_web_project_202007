...
/**
 * @description : 입력값의 검사를 수행하기 위한 객체
 * @author      : 오 혜 진
 */
...
var regex = {
     ...
     * @param  {string} selector    입력요소의 css셀렉터
     * @param  {string} msg         값이 없을 경우 표시될 메시지
     * @return 체크된경우 true / 체크되지 않은 경우 false
     */
     ...
     * @param  {string} selector    검사대상의 selector
    ...
    email: function(selector, msg) {
        return this.field(selector, msg, /^([\w-\.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([\w-]+\.)+))([a-zA-Z]{2,4}|[0-9]{1,3})(\]?)$/);
    },
