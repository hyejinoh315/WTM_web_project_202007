...
@Slf4j
@Service
public class CovidConfirmServiceImpl implements CovidConfirmService {
    ...
    public CovidConfirm getCovidConfirmItem(CovidConfirm input) throws Exception {
        CovidConfirm result = null;

        try {
            result = sqlSession.selectOne("CovidConfirmMapper.selectItem", input);
    ...
    public List<CovidConfirm> getCovidConfirmList(CovidConfirm input) throws Exception {
        List<CovidConfirm> result = null;

        try {
            result = sqlSession.selectList("CovidConfirmMapper.selectList", input);
            if (result == null) {
                throw new NullPointerException("result=null");
            }
        } catch (NullPointerException e) {
    ...
    public int getCovidConfirmCount(CovidConfirm input) throws Exception {
        ...
        try {
            result = sqlSession.selectOne("CovidConfirmMapper.selectCountAll", input);
        } catch (Exception e) {
            log.error(e.getLocalizedMessage());
            throw new Exception("데이터 조회에 실패했습니다.");
        }
    ...
    public int addCovidConfirm(CovidConfirm input) throws Exception {
        ...
        try {
            result = sqlSession.insert("CovidConfirmMapper.insertItem", input);
    ...
    public int editCovidConfirm(CovidConfirm input) throws Exception {
        ...
        try {
            result = sqlSession.update("CovidConfirmMapper.updateItem", input);
            if (result == 0) {
                throw new NullPointerException("result=0");
            }
        } catch (NullPointerException e) {
    ...
    public int deleteCovidConfirm(CovidConfirm input) throws Exception {
        ...
        try {
            result = sqlSession.delete("CovidConfirmMapper.deleteItem", input);
            if (result == 0) {
                throw new NullPointerException("result=0");
            }
        } catch (NullPointerException e) {
