...
@Slf4j
@Service
public class CovidRegionServiceImpl implements CovidRegionService {
    ...
    public CovidRegion getCovidRegionItem(CovidRegion input) throws Exception {
        CovidRegion result = null;

        try {
            result = sqlSession.selectOne("CovidRegionMapper.selectItem", input);
    ...
    public List<CovidRegion> getCovidRegionList(CovidRegion input) throws Exception {
        List<CovidRegion> result = null;

        try {
            result = sqlSession.selectList("CovidRegionMapper.selectList", input);
            if (result == null) {
                throw new NullPointerException("result=null");
            }
        } catch (NullPointerException e) {
    ...
    public int getCovidRegionCount(CovidRegion input) throws Exception {
        ...
        try {
            result = sqlSession.selectOne("CovidRegionMapper.selectCountAll", input);
        } catch (Exception e) {
            log.error(e.getLocalizedMessage());
            throw new Exception("데이터 조회에 실패했습니다.");
        }
    ...
    public int addCovidRegion(CovidRegion input) throws Exception {
        ...
        try {
            result = sqlSession.insert("CovidRegionMapper.insertItem", input);
    ...
    public int editCovidRegion(CovidRegion input) throws Exception {
        ...
        try {
            result = sqlSession.update("CovidRegionMapper.updateItem", input);
            if (result == 0) {
                throw new NullPointerException("result=0");
            }
        } catch (NullPointerException e) {
    ...
    public int deleteCovidRegion(CovidRegion input) throws Exception {
        ...
        try {
            result = sqlSession.delete("CovidRegionMapper.deleteItem", input);
            if (result == 0) {
                throw new NullPointerException("result=0");
            }
        } catch (NullPointerException e) {
